...
def create_layout():
    """Erstellt das gesamte Layout der Dash-App."""
    return html.Div([
...
def _create_navbar():
    ...
    return html.Div([
        html.Button(
            ...
            n_clicks=0,  # Changed from 1 to 0
            style={
                'flex': '1',
                'padding': '10px 20px',
                'margin': '0 5px',
...
def _create_map_and_table_container():
    """Erstellt den Container für Karte und Tabelle."""
    return html.Div(id="map-and-table-container", children=[
        ...
        'display': 'flex', 'flexDirection': 'column' # Standard: sichtbar
    })

def _create_diagram_container():
    """Erstellt den Container für die Diagramme."""
    return html.Div(id="diagram-container", children=[
        ...
        'flex': '75%', 'padding': '10px',
        'display': 'none', 'flexDirection': 'column' # Standard: versteckt
    })

def _create_control_panel():
    """Erstellt das Steuerungsfeld mit allen Filtern."""
    return html.Div([
        # Masse-Filter
